...
('doc-1', 'a1111111-1111-1111-1111-111111111111', 'Discharge Summary (Heart Care Clinic 2025)', 'docs/discharge_summary_2025.pdf', 'discharge_summary'),
('doc-2', 'a1111111-1111-1111-1111-111111111111', 'ECG Report Jan 2026', 'docs/ecg_jan_2026.pdf', 'scan');
...
('hs-1', '22222222-2222-2222-2222-222222222222', 'h1111111-1111-1111-1111-111111111111', true);

-- 6. Insert Ambulances
INSERT INTO public.ambulances (id, vehicle_number, status, current_latitude, current_longitude) VALUES
('amb-11111-1111-1111-1111-111111111111', 'AP 05 AB 1234', 'AVAILABLE', 17.0020, 81.7820),
('amb-22222-2222-2222-2222-222222222222', 'AP 05 CD 5678', 'AVAILABLE', 17.0090, 81.7890);

-- 7. Insert Ambulance Drivers
INSERT INTO public.ambulance_drivers (id, user_id, ambulance_id, driver_name, phone) VALUES
('drv-1', '33333333-3333-3333-3333-333333333333', 'amb-11111-1111-1111-1111-111111111111', 'Suresh Kumar', '+919876543212');
